  ...
  module Strongs
    class Annotator < CSKit::Annotator
      ...
      def get_formatter(type = :plain_text)
        case type
          when :plain_text
            CSKit::Strongs::Formatters::StrongsPlainTextFormatter
          when :html
            CSKit::Strongs::Formatters::StrongsHtmlFormatter
        end
      end
      ...
      def concordance_base_path
        @concordance_base_path ||= File.join(
          CSKit::Strongs.resource_dir, 'concordance'
        )
      end

      def lexicon_base_path
        @lexicon_base_path ||= File.join(CSKit::Strongs.resource_dir, 'lexicon')
      end
